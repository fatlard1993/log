		...
		constructor(opts = {}) {
			...
			const createLogger = method => {
				...
				return function (verbosity) {
					...
					const colorMap = Object.assign(opts.colorMap || {}, Log.prototype.defaults.colorMap),
						mappedColor = colorMap[method] || colorMap[tag];
			...
			const logger = new Proxy(createLogger('log'), {
				get(target, method) {
					return typeof target[method] !== 'undefined' ? target[method] : createLogger(method);
				},
			});
